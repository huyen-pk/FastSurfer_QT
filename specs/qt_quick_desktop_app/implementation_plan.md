...
- `_app/cmake`, `_app/rendering`, and `_app/scripts` are currently empty placeholders.
- `core/` is the live native processing module root.
- `specs/` is the live spec artifact root.
...
- Step 3: `specs/qt_quick_desktop_app/bdd_requirements.md`
